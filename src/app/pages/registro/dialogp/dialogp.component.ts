...
@Component({
  selector: 'app-dialogp',
  templateUrl: './dialogp.component.html',
  styleUrls: ['./dialogp.component.css'],
  providers: [ProvinciaService]
  /*si no quisiera poner providedIn: 'root' en el service de provincias entonces donde 
    solo quiero utilizar ese servicio pongo lo siguiente*/
  //constructor (private dataSvc:ProvinciaService)
})
export class DialogpComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DialogpComponent>,
