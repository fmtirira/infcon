...
@Component({
  selector: 'app-dialogieditar',
  templateUrl: './dialogieditar.component.html',
  styleUrls: ['./dialogieditar.component.css'],
  providers: [ProvinciaService]
})
export class DialogieditarComponent implements OnInit {
  institucionRef: any;
