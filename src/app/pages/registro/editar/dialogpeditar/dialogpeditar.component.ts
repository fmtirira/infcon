...
@Component({
  selector: 'app-dialogpeditar',
  templateUrl: './dialogpeditar.component.html',
  styleUrls: ['./dialogpeditar.component.css'],
  providers: [ProvinciaService] 
})
export class DialogpeditarComponent implements OnInit {
  presidenteRef: any;
